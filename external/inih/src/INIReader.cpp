...
string INIReader::Get(const string& section,
                      const string& name,
...
INI_API int64_t INIReader::GetInteger64(const std::string& section,
...
unsigned long INIReader::GetUnsigned(const string& section,
                                     const string& name,
...
INI_API uint64_t INIReader::GetUnsigned64(const std::string& section,
                                          const std::string& name,
...
bool INIReader::GetBoolean(const string& section,
                           const string& name,
                           bool          default_value) const {
  string valstr = Get(section, name, "");
  // Convert to lower case to make string comparisons case-insensitive
  std::transform(valstr.begin(),
                 valstr.end(),
                 valstr.begin(),
